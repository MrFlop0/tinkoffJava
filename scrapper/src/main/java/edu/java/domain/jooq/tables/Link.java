...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, Integer> TYPE =
        createField(DSL.name("TYPE"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>LINK.STARS_COUNT</code>.
     */
    public final TableField<LinkRecord, Integer> STARS_COUNT =
        createField(DSL.name("STARS_COUNT"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>LINK.ANSWERS_COUNT</code>.
     */
    public final TableField<LinkRecord, Integer> ANSWERS_COUNT =
        createField(DSL.name("ANSWERS_COUNT"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>LINK.UPDATE_DATE</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> UPDATE_DATE =
        createField(DSL.name("UPDATE_DATE"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>LINK.PREVIOUS_CHECK</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> PREVIOUS_CHECK =
        createField(DSL.name("PREVIOUS_CHECK"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super String, ? super Integer, ? super Integer, ? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function6<? super String, ? super Integer, ? super Integer, ? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from
    ) {
