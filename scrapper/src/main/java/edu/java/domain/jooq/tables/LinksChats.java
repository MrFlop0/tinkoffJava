...
public class LinksChats extends TableImpl<LinksChatsRecord> {
    ...
    /**
     * The column <code>LINKS_CHATS.LINK</code>.
     */
    public final TableField<LinksChatsRecord, String> LINK =
    ...
    public List<ForeignKey<LinksChatsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_45, Keys.CONSTRAINT_453);
    }
    ...
    public Chat chat() {
        if (_chat == null) {
            _chat = new Chat(this, Keys.CONSTRAINT_45);
        }
    ...
    public Link link() {
        if (_link == null) {
            _link = new Link(this, Keys.CONSTRAINT_453);
        }
